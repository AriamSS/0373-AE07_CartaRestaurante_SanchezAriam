...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
    <div class="container-fluid">
        <a class="navbar-brand text-primary" href="index.php"><strong>Menú Cubano - Sabor Tradicional</strong></a>
...
<div class="container mt-4">
    ...
    <div class="text-center mb-4">
        <img src="img/cuba.jpg" alt="Bandera Cubana" style="width: 200px; height: auto;">
    </div>
    <?php if ($tipoSeleccionado !== ''): ?>
        <p class="text-center text-light">Mostrando todos los platos de la categoria <strong><?php echo ucfirst($tipoSeleccionado); ?></strong></p>
    <?php else: ?>
    ...
    <div class="row">
        ...
        foreach ($menu->plato as $plato) {
            $tipo = (string)$plato['tipo'];
            if (!in_array($tipo, $tiposMostrados)) {
                echo '<div class="col-12">';
                echo '<h2 class="text-center text-danger mt-4">' . ucfirst($tipo) . '</h2>';
                echo '</div>';
                $tiposMostrados[] = $tipo;
            }

            if ($tipoSeleccionado === '' || $tipoSeleccionado === $tipo) {
